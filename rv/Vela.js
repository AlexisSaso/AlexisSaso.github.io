...
var pared1 = new THREE.Mesh(new THREE.BoxGeometry(1,20,10), new THREE.MeshPhongMaterial({color:0x00FF37}));
var pared2 = new THREE.Mesh(new THREE.BoxGeometry(1,20,10), new THREE.MeshPhongMaterial({color:0x00FF37}));
var pared3 = new THREE.Mesh(new THREE.BoxGeometry(21,1,10), new THREE.MeshPhongMaterial({color:0x00FF37}));
var pared4 = new THREE.Mesh(new THREE.BoxGeometry(21,1,10), new THREE.MeshPhongMaterial({color:0x00FF37}));
var floor=new THREE.Mesh(new THREE.BoxGeometry(20,20,0.1), new THREE.MeshLambertMaterial({color:0x00FF37}));
floor.position.z=-5;
floor.position.x=0;
floor.position.y=0;
...
luz=new THREE.SpotLight(0x00FF37);
luzPuntual=new THREE.PointLight(0x00FF37);
