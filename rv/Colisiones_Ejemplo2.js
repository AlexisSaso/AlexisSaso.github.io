function setup(){
  cubo1 = new THREE.Mesh( new THREE.BoxGeometry( 1, 14, 1),
                          new THREE.MeshNormalMaterial());
  cubo2 = new THREE.Mesh( new THREE.BoxGeometry( 1, 14, 1),
                          new THREE.MeshNormalMaterial());
  cubo3 = new THREE.Mesh( new THREE.BoxGeometry( 14, 1, 1),
                          new THREE.MeshNormalMaterial());
  cubo4 = new THREE.Mesh( new THREE.BoxGeometry( 14, 1, 1),
                          new THREE.MeshNormalMaterial());
