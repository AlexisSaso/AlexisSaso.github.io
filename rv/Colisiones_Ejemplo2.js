function setup(){
  cubo1 = new THREE.Mesh( new THREE.BoxGeometry( 1, 16, 1),
                          new THREE.MeshNormalMaterial());
  cubo2 = new THREE.Mesh( new THREE.BoxGeometry( 1, 16, 1),
                          new THREE.MeshNormalMaterial());
  cubo3 = new THREE.Mesh( new THREE.BoxGeometry( 16, 1, 1),
                          new THREE.MeshNormalMaterial());
  cubo4 = new THREE.Mesh( new THREE.BoxGeometry( 16, 1, 1),
                          new THREE.MeshNormalMaterial());
