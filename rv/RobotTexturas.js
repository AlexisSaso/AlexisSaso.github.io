function Completo(){
  ...
  var cara = THREE.ImageUtils.loadTexture('http://Ignacio121990.github.io/rv/robotkirby.jpg');
  ...
  this.pieI = new THREE.Mesh(new THREE.BoxGeometry(2,1,0.5),new THREE.MeshPhongMaterial({map:pies}));
  this.pieD = new THREE.Mesh(new THREE.BoxGeometry(2,1,0.5),new THREE.MeshPhongMaterial({map:pies}));
